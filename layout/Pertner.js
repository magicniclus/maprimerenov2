...
const navigation = [
  { name: "Dashboard", href: "/mon-espace", current: true },
  { name: "Entreprises", href: "/mon-espace/entreprise", current: false },
  { name: "Leads", href: "/mon-espace/leads", current: false },
...
const Pertner = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Vérifiez si navItems et updatedNavItems sont différents
    if (JSON.stringify(navItems) !== JSON.stringify(updatedNavItems)) {
